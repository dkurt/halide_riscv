...
PERF_TEST(idw, halide_parallel) {
    ...
    PERF_SAMPLE_BEGIN()
        idw_halide_parallel(NULL, dst.ptr<uint8_t>(), height, width, idwPoints, idwWeights);
    PERF_SAMPLE_END()

    SANITY_CHECK_NOTHING();
}

PERF_TEST(idw, halide_vec) {
    const int width = 1920;
    const int height = 1080;
    ...
    PERF_SAMPLE_BEGIN()
        idw_halide_vec(NULL, dst.ptr<uint8_t>(), height, width, idwPoints, idwWeights);
    PERF_SAMPLE_END()

    SANITY_CHECK_NOTHING();
}

PERF_TEST(idw, halide_parallel_vec) {
    const int width = 1920;
    const int height = 1080;
    ...
    PERF_SAMPLE_BEGIN()
        idw_halide_parallel_vec(NULL, dst.ptr<uint8_t>(), height, width, idwPoints, idwWeights);
    PERF_SAMPLE_END()
