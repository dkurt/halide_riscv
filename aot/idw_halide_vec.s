	...
	.section	.text.idw_halide_vec_,"ax",@progbits
	.globl	idw_halide_vec_                 # -- Begin function idw_halide_vec_
	.p2align	1
	.type	idw_halide_vec_,@function
idw_halide_vec_:                        # @idw_halide_vec_
# %bb.0:                                # %entry
	addi	sp, sp, -192
...
.Lpcrel_hi0:
	auipc	a1, %pcrel_hi(.Lb44.buffer)
	addi	a1, a1, %pcrel_lo(.Lpcrel_hi0)
	ld	s6, 16(a1)
	ld	a3, 40(a0)
.Lpcrel_hi1:
	auipc	a2, %pcrel_hi(.Lb45.buffer)
...
.LBB0_9:                                # %_halide_buffer_is_bounds_query.exit50
	...
	or	a0, a0, a1
	bnez	a0, .LBB0_20
# %bb.10:                               # %"for idw_halide_vec_.s0.y.rebased.preheader"
	ld	s3, 16(sp)                      # 8-byte Folded Reload
	ld	a0, 24(sp)                      # 8-byte Folded Reload
	blez	a0, .LBB0_13
# %bb.11:                               # %"for idw_halide_vec_.s0.y.rebased.us.preheader"
	li	s0, 0
	ld	s2, 24(sp)                      # 8-byte Folded Reload
	slli	s2, s2, 2
	ld	s1, 32(sp)                      # 8-byte Folded Reload
.LBB0_12:                               # %"for idw_halide_vec_.s0.y.rebased.us"
	...
	addw	s0, s0, s3
	bnez	s1, .LBB0_12
.LBB0_13:                               # %"for idw_halide_vec_.s1.y.rebased.preheader"
	...
	li	ra, 2
	li	a6, 3
.LBB0_14:                               # %"for idw_halide_vec_.s1.y.rebased"
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_16 Depth 2
                                        #       Child Loop BB0_17 Depth 3
	ld	a0, 24(sp)                      # 8-byte Folded Reload
	blez	a0, .LBB0_19
# %bb.15:                               # %"for idw_halide_vec_.s1.x.rebased.preheader"
	...
	addw	a0, a0, a4
.LBB0_16:                               # %"for idw_halide_vec_.s1.x.rebased"
	...
	mv	s3, s6
	mv	s10, s9
.LBB0_17:                               # %"for idw_halide_vec_.s1.r24$x.r24$x"
                                        #   Parent Loop BB0_14 Depth=1
	...
	addi	s3, s3, 48
	bnez	s5, .LBB0_17
# %bb.18:                               # %"end for idw_halide_vec_.s1.r24$x.r24$x"
                                        #   in Loop: Header=BB0_16 Depth=2
	addi	t4, t4, 1
	fsw	ft0, 0(s2)
	bne	t4, s8, .LBB0_16
.LBB0_19:                               # %"end for idw_halide_vec_.s1.x.rebased"
                                        #   in Loop: Header=BB0_14 Depth=1
	ld	a4, 40(sp)                      # 8-byte Folded Reload
	addi	a4, a4, 1
...
.LBB0_20:                               # %destructor_block
	...
	ret
.Lfunc_end0:
	.size	idw_halide_vec_, .Lfunc_end0-idw_halide_vec_
                                        # -- End function
	.section	.text.idw_halide_vec__argv,"ax",@progbits
	.globl	idw_halide_vec__argv            # -- Begin function idw_halide_vec__argv
	.p2align	1
	.type	idw_halide_vec__argv,@function
idw_halide_vec__argv:                   # @idw_halide_vec__argv
# %bb.0:                                # %entry
	addi	sp, sp, -16
	sd	ra, 8(sp)                       # 8-byte Folded Spill
	ld	a0, 0(a0)
	call	idw_halide_vec_@plt
	li	a0, 0
	ld	ra, 8(sp)                       # 8-byte Folded Reload
	addi	sp, sp, 16
	ret
.Lfunc_end1:
	.size	idw_halide_vec__argv, .Lfunc_end1-idw_halide_vec__argv
                                        # -- End function
	.section	.text.idw_halide_vec__metadata,"ax",@progbits
	.globl	idw_halide_vec__metadata        # -- Begin function idw_halide_vec__metadata
	.p2align	1
	.type	idw_halide_vec__metadata,@function
idw_halide_vec__metadata:               # @idw_halide_vec__metadata
# %bb.0:                                # %entry
.Lpcrel_hi2:
	auipc	a0, %pcrel_hi(.Lidw_halide_vec__metadata_storage)
	addi	a0, a0, %pcrel_lo(.Lpcrel_hi2)
	ret
.Lfunc_end2:
	.size	idw_halide_vec__metadata, .Lfunc_end2-idw_halide_vec__metadata
                                        # -- End function
	.type	.Lb44.shape,@object             # @b44.shape
...
.Lb44.shape:
	...
	.type	.Lb44.data,@object              # @b44.data
	.p2align	5, 0x0
.Lb44.data:
	...
	.type	.Lb44.buffer,@object            # @b44.buffer
	.data
	.p2align	4, 0x0
.Lb44.buffer:
	.quad	0                               # 0x0
	...
	.type	.Lb45.shape,@object             # @b45.shape
	.section	.rodata,"a",@progbits
	.p2align	5, 0x0
.Lb45.shape:
	...
	.type	.Lb45.data,@object              # @b45.data
	.p2align	5, 0x0
.Lb45.data:
	...
	.type	.Lb45.buffer,@object            # @b45.buffer
	.data
	.p2align	4, 0x0
.Lb45.buffer:
	.quad	0                               # 0x0
...
.Lstr.4:
	...
	.type	.Lidw_halide_vec__metadata_storage,@object # @idw_halide_vec__metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4, 0x0
.Lidw_halide_vec__metadata_storage:
	.word	1                               # 0x1
	.word	1                               # 0x1
	.quad	.L__unnamed_2
	.quad	.Lstr.4
	.quad	.Lstr
	.size	.Lidw_halide_vec__metadata_storage, 32
